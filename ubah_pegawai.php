                                ...
                                <div class="row gy-1 overflow-hidden">
                                    <div class="col-12">
                                        <div class="form-floating mb-1">
                                            ...
                                            <input type="email" class="form-control" name="email" id="email" value="<?= $data_pegawai['email'] ?>" placeholder="Email" required>
                                            <label for="email" class="form-label">Email</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating mb-1">
                                            <input type="password" class="form-control" name="password" id="password" value="<?= $data_pegawai['password'] ?>" placeholder="Password" required>
                                            <label for="password" class="form-label">Password</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating mb-1">
                                            <input type="number" class="form-control" name="nik" id="nik" value="<?= $data_pegawai['nik'] ?>" placeholder="NIK" required>
                                            <label for="nik" class="form-label">NIK</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating mb-1">
                                            <input type="text" class="form-control" name="nama" id="nama" value="<?= $data_pegawai['nama'] ?>" placeholder="Nama" required>
                                            <label for="nama" class="form-label">Nama</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating mb-1">
                                            <textarea class="form-control" name="alamat" id="alamat" value="<?= $data_pegawai['alamat'] ?>" placeholder="Alamat" required></textarea>
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating mb-1">
                                            <input type="number" class="form-control" name="telp" id="telp" value="<?= $data_pegawai['telp'] ?>" placeholder="Nomor Telepon" required>
                                    ...
                                    <div class="col-12">
                                        <div class="d-grid">
                                            <button class="btn btn-primary btn-lg" type="submit">Ubah Pegawai</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
